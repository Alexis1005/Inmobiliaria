...
<footer class="footer bg-success text-white py-4"> 
    <div class="container">
        <div class="row m-0">
            ...
            <div class="col-md-8 text-center text-md-start p-0 m-0 contenedorGeneral">
                ...
                <div class="col-12 aviso-legal p-0">
                    <p class="small">
                        Todas las medidas enunciadas son meramente orientativas. Las medidas exactas serán las que se expresen en el respectivo título de propiedad de cada inmueble. Los precios enunciados son meramente orientativos y no contractuales.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center text-md-end contact-info">
                <p class="mb-3"><i class="bi bi-telephone-fill me-2"></i> 3446-334455</p>
                <p class="mb-3"><i class="bi bi-geo-alt-fill me-2"></i> Urdinarrain, Entre Ríos</p>
                <p class="mb-1"><i class="bi bi-envelope-fill me-2"></i> morenogaleano@gmail.com</p>
            </div>
        </div>
        <!-- Línea divisoria -->
        <div class="lineaDivisoria">
            <hr class="border-white lineaDivisoria my-3" style="border-width: 3px;">
        </div>
        <!-- Derechos de Autor -->
