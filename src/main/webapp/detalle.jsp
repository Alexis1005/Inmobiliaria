...
<html lang="es">
    ...
    <body style="background-color: #19875409;">
        ...
        <div class="container mt-3">
            <div class="row g-2">
                <div class="col-md-8">
                    ...
                    <c:if test="${not empty propiedad.caracteristicasGenerales}">
                        <p>${propiedad.caracteristicasGenerales}</p>
                    </c:if>
                    <c:if test="${empty propiedad.caracteristicasGenerales}">
                        <p>No hay características generales disponibles.</p>
                    </c:if>
                    <hr class="w-75">
        ...
        <!-- Ubicación -->
        <div class="container m-0 p-0" style="border:5px;">
            <h3 style="margin-left: 6%;">Ubicación</h3>
            <iframe class="w-100" style="text-align: center" src="https://www.google.com/maps?q=${propiedad.direccion}&output=embed" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
